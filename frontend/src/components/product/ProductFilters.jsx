  ...
  return (
    <div className="relative h-5 flex items-center">
      ...
      <div
        ...
        style={{ backgroundColor: 'var(--bw-outline-variant, ***REMOVED***c4c6cd)' }}
      />
      ...
      <div
        ...
        style={{
          left:            `${pctLo}%`,
          width:           `${pctHi - pctLo}%`,
          backgroundColor: 'var(--bw-primary, ***REMOVED***041627)',
        }}
      />
  ...
  >
    <span
      ...
      style={{
        ...
        border:          active ? 'none' : '1px solid var(--bw-outline-variant, ***REMOVED***c4c6cd)',
      }}
    />
    <span
