      ...
      <article className="group flex flex-col gap-4">
        ...
        <Link to={`/products/${_id}`} className="block">
          <div
            ...
            style={{ backgroundColor: 'var(--bw-surface-container-low, ***REMOVED***f5f3ee)' }}
          >
            {thumbnail && !imgError ? (
              <img
                src={thumbnail}
        ...
        <div className="flex flex-col gap-1">
          ...
          {category && (
            <p
              ...
              style={{ color: 'var(--bw-on-surface-variant, ***REMOVED***44474c)' }}
            >
              {category}
            </p>
          )}
          ...
          <Link to={`/products/${_id}`}>
            <h3
              ...
              style={{
                color:      'var(--bw-primary, ***REMOVED***041627)',
                fontFamily: "'Newsreader', Georgia, serif",
              }}
              onMouseEnter={e => (e.currentTarget.style.color = 'var(--bw-secondary, ***REMOVED***3b6934)')}
              onMouseLeave={e => (e.currentTarget.style.color = 'var(--bw-primary, ***REMOVED***041627)')}
            >
              {title}
            </h3>
          </Link>
            ...
            <button
              ...
              style={{
                ...
                color: outOfStock
                  ...
                  : 'var(--bw-on-primary, ***REMOVED***ffffff)',
                border: outOfStock
                  ? '1px solid var(--bw-outline-variant, ***REMOVED***c4c6cd)'
                  : 'none',
              }}
              onMouseEnter={e => {
                if (!outOfStock && !adding)
                  e.currentTarget.style.backgroundColor = 'var(--bw-primary-container, ***REMOVED***1a2b3c)';
              }}
              onMouseLeave={e => {
                if (!outOfStock && !adding)
                  e.currentTarget.style.backgroundColor = 'var(--bw-primary, ***REMOVED***041627)';
              }}
            >
              {adding ? (
                <svg
...
const BookCoverPlaceholder = ({ title }) => (
  <div
    className="w-4/5 aspect-[3/4] rounded-md flex flex-col items-center
               ...
               group-hover:-translate-y-2 transition-transform duration-500"
    style={{ backgroundColor: 'var(--bw-surface-container-high, ***REMOVED***eae8e3)' }}
  >
    <span
      className="material-symbols-outlined"
      style={{ fontSize: '40px', color: 'var(--bw-outline, ***REMOVED***74777d)' }}
    >
      menu_book
    </span>
    <span
