...
const Products = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'var(--bw-surface-container-lowest, ***REMOVED***fbf9f4)' }}
    >
      <main
      ...
      >
        ...
        <div className="flex-grow flex flex-col gap-8">
          ...
          <div
            ...
            style={{
              borderBottom: '1px solid var(--bw-surface-container-highest, ***REMOVED***e4e2dd)',
            }}
          >
            <h2
            ...
            >
              ...
              <span
                ...
                style={{
                  fontSize: '1rem',
                  color:    'var(--bw-on-surface-variant, ***REMOVED***44474c)',
                }}
              >
...
const CatalogFooter = () => (
  <footer
    ...
    style={{ backgroundColor: 'var(--bw-primary, ***REMOVED***041627)', color: '***REMOVED***fbf9f4' }}
  >
        ...
        <div key={i} className="flex flex-col gap-3">
          {links.map(label => (
            <a
              ...
              onMouseEnter={e => (e.currentTarget.style.color = '***REMOVED***fbf9f4')}
