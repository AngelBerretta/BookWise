...
const posts = [
  ...
  { title: 'Entrevista: el proceso creativo detrás de un bestseller', slug: 'entrevista-el-proceso-creativo-detras-de-un-bestseller', content: 'Conversamos con autores sobre cómo nace una historia, desde la primera idea hasta la publicación.\n\nUn proceso que mezcla disciplina, intuición y muchísima reescritura.', tags: ['entrevista', 'autores'], published: true },
  { title: 'Los mejores libros de ciencia ficción de la última década', slug: 'los-mejores-libros-de-ciencia-ficcion-de-la-ultima-decada', content: 'La ciencia ficción contemporánea sigue reinventándose.\n\nDesde distopías climáticas hasta space operas, repasamos las obras más influyentes de los últimos diez años.', tags: ['ciencia-ficción', 'recomendaciones'], published: true },
  ...
  { title: 'Libros de desarrollo personal que realmente funcionan', slug: 'libros-de-desarrollo-personal-que-realmente-funcionan', content: 'No todos los libros de autoayuda están hechos igual.\n\nSeleccionamos algunos que combinan evidencia científica con consejos prácticos y aplicables.', tags: ['desarrollo-personal'], published: true },
  { title: 'Cómo la tecnología está cambiando la forma de leer', slug: 'como-la-tecnologia-esta-cambiando-la-forma-de-leer', content: 'Ebooks, apps de lectura social y recomendaciones por IA: el ecosistema lector se transforma constantemente.\n\nExploramos las tendencias que definen el futuro cercano.', tags: ['tecnología', 'ebooks'], published: true },
